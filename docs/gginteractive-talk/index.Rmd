...
- Organize special R objects in a browser
- Controls trigger updates to R code running on a server
- R then updates plots/tables/analyses
- "Reactive", not really interactive
...
- Essentially standalone documents, can be easily shared and embedded in web pages
    
### Path forward
- Create `R` packages to accomplish specific task, e.g. `plotROC`, `ggkm`
...
- [Slides](https://sachsmc.github.io/gginteractive/gginteractive-talk/) and [github.com/sachsmc/gginteractive](https://github.com/sachsmc/gginteractive)
